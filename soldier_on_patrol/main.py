...
def on_key_press(symbol, modifiers):
    if symbol == KEY.P:
        ...
        enemy = Agent(world, Vector2D(randrange(world.cx), randrange(world.cy)), 30.0, 1.0, 'zombie', 'RED', 1.0)
        world.agents.append(enemy)
        world.hostiles.append(enemy)
...
if __name__ == '__main__':
    ...
    world = World(500, 500)
    # add one agent
    main = Agent(world, Vector2D(world.target.x, world.target.y), 30.0, 1.0, 'soldier', 'GREEN', 2.0)
